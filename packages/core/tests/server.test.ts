...
import { Task, Message, Artifact } from '../src/types/task.js';
...
class MockServer extends A2AServer {
  constructor() {
    super({
      ...
      version: '1.0.0',
      capabilities: { streaming: true, pushNotifications: false, stateTransitionHistory: true, extendedAgentCard: false },
      skills: [],
